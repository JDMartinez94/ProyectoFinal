...
import modelo.OperacionesC;
/**
 *
 * @author jdmar
 */
public class DAOOperacionesC implements Operaciones {
    
    Database db = new Database();
    OperacionesC oper = new OperacionesC();
    

    @Override
    public boolean insertar(Object obj) {
        
        this.oper = (OperacionesC) obj;
        Connection con;
        ...
        try{
            ...
            //pst.setInt(1, this.oper.getIdPaciente().getIdPaciente());
